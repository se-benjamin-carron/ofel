...
{
    public class MassMatrixTests : BaseTestWithResults
    {
        ...
        public void MassMatrix_BasicEntries()
        {
            ...
            WriteResults(expected, calculated, nameof(MassMatrix_BasicEntries));
        }
        ...
        public void MassMatrix_IsSymmetric()
        {
            ...
            WriteResults(new List<string> { "MassMatrix symmetry" }, new List<string> { "Symmetric: true" }, nameof(MassMatrix_IsSymmetric));
        }
        ...
        public void MassMatrix_Formulas_MatchExpected()
        {
            ...
            WriteResults(new List<string> { "MassMatrix formula checks" }, new List<string> { $"M[4,4]={M[4,4]:G17}", $"M[1,11]={M[1,11]:G17}", $"M[3,9]={M[3,9]:G17}" }, nameof(MassMatrix_Formulas_MatchExpected));
        }
        ...
        public void MassMatrix_FullMatrixMatchesExpected()
        {
            ...
            WriteResults(new List<string> { "MassMatrix full-matrix comparison" }, new List<string> { $"MaxDiff={maxDiff:E17}" }, nameof(MassMatrix_FullMatrixMatchesExpected));
        }
    }
}
